...
#define SBX_REPORT_STRING_WINDOW_MISSING_ARGUMENT       "One or more required arguments set to an invalid value (NULL or 0)"
...
#define SBX_REPORT_STRING_WINDOW_DESTRUCTION_SUCCESSFUL "Successfuly destroyed/freed window object"
