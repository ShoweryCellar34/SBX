...
#define SBX_REPORT_STRING_CREATION_SUCCESSFUL         "Successfuly created/allocated object"
#define SBX_REPORT_STRING_DESTRUCTION_SUCCESSFUL      "Successfuly destroyed/freed object"
